...
const Technology = () => {
    ...
    },
    {
      ...
      img: "https://cdn.prod.website-files.com/67b8bc4997c0fc01bf688eff/67bd733182cb179aa260c21a_Frame%201321316744-4-p-500.webp"
    },
    {
      id: 3,
      category: "Technology",
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-12">
        {blogPosts.map((post) => (
          <div key={post.id} className="group cursor-pointer flex flex-col h-full">
            ...
            <div className="relative overflow-hidden aspect-square rounded-2xl bg-gray-50 mb-4">
        
              <span className="absolute top-4 left-4 z-10 bg-white/95 backdrop-blur-sm text-[11px] font-semibold tracking-wide text-gray-800 px-3 py-1.5 rounded-md shadow-sm border border-gray-100">
                {post.category}
              </span>
